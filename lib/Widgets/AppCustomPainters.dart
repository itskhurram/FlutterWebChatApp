...
class AppDrawCircle extends CustomPainter {
  AppDrawCircle({
    ...
    this.shadowOffset = AppSizes.SIZE_1,
  }) {
    _paint = Paint()
      ..color = color
      ..strokeWidth = 10.0
...
class AppDrawTearDrop extends CustomPainter {
  AppDrawTearDrop({
    @required this.radius,
    @required this.offset,
    @required this.color,
    ...
    this.hasShadow = false,
    this.shadowOffset = AppSizes.SIZE_1,
    this.tearDropAlignment = AppTearDropAlignment.topLeft,
  }) {
    _paint = Paint()
      ..color = color
