...
class AppColors {
  static const Color ucDavisBlue = Color.fromRGBO(2, 40, 80, 1.0);
  static const Color ucDavisGoldLine = Color.fromARGB(255, 93, 95, 52);
  static const Color ucDavisYellow =
      Color.fromRGBO(255, 191, 0, 1.0); //Colors.yellow;
  static const Color ucDavisWhite = Colors.white;
  static const Color ucDavisGreen = Colors.green;
